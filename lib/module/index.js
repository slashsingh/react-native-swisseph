...
export function sweTimeEqu(tjd) {
  return Native.sweTimeEqu(tjd);
}
export function sweRiseTrans(tjdUt, planet, starName, epheflag, rsmi, atPressure, atTemperature) {
  return Native.sweRiseTrans(tjdUt, planet, starName, epheflag, rsmi, atPressure, atTemperature);
}
