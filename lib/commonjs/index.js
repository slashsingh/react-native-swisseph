...
function sweTimeEqu(tjd) {
  return _NativeSwisseph.default.sweTimeEqu(tjd);
}
function sweRiseTrans(tjdUt, planet, starName, epheflag, rsmi, atPressure, atTemperature) {
  return _NativeSwisseph.default.sweRiseTrans(tjdUt, planet, starName, epheflag, rsmi, atPressure, atTemperature);
}
